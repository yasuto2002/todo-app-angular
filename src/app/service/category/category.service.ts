...
export class CategoryService {
  ...
  ): Observable<HttpResponse<CategoryIdResponse>> {
    const url = `${environment.apiUrl}/category`;
    return this.http
      .post<CategoryIdResponse>(url, category, { observe: 'response' })
      .pipe(catchError((error) => this.handleError(error, this.router)));
  }
  ...
  updateCategory(
    ...
    return this.http
      .put<CategoryResponse>(url, category, this.httpOptions)
      .pipe(catchError((error) => this.handleError(error, this.router)));
  }
